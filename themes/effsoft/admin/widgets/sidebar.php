...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center"
       href="<?= Url::to(['/admin/dashboard'], true); ?>">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSitePage"
           aria-expanded="true" aria-controls="collapseSitePage">
        ...
        <div id="collapseSitePage" class="collapse">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item"
                   href="<?= Url::to(['/site/admin/page/manage'], true); ?>"><?= Yii::t('app', 'All'); ?></a>
                <a class="collapse-item"
                   href="<?= Url::to(['/site/admin/page/create'], true); ?>"><?= Yii::t('app', 'Create'); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseCotentCateogry" class="collapse">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item"
                   href="<?= Url::to(['/content/admin/category/manage'], true); ?>"><?= Yii::t('app', 'All'); ?></a>
                <a class="collapse-item"
                   href="<?= Url::to(['/content/admin/category/create'], true); ?>"><?= Yii::t('app', 'Create'); ?></a>
            </div>
        </div>
    </li>
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseContentPage"
           aria-expanded="true" aria-controls="collapseContentPage">
